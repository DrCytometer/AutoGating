# do_gate_memory_cd4.r

do.gate.memory.cd4 <- function( fcs.exp.data, fcs.gates, fcs.calculate,
                                figure.dir )
{
  fcs.gate.a.label <- "Naive CD4+ T cells"
  fcs.gate.b.label <- "Central Memory CD4+ T cells"
  fcs.gate.c.label <- "Effector Memory CD4+ T cells"
  fcs.gate.d.label <- "Effector Memory RA CD4+ T cells"
  ...
  ggsave( file.path( figure.dir, "memory_cd4.png" ),
          width = 9, height = 7.5 )
