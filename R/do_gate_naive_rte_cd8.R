# do_gate_naive_rte_cd8.r

do.gate.naive.rte.cd8 <- function( fcs.exp.data, fcs.gates,
                                   fcs.calculate, figure.dir )
{
  fcs.gate.label <- "CD8+ T-cell Recent Thymic Emigrants"
  ...
  ggsave( file.path( figure.dir, "naive_rte_cd8.png" ),
          width = 9, height = 7.5 )
